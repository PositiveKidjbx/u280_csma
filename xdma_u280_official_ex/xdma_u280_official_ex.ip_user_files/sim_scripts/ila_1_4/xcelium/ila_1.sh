...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../xdma_u280_official_ex.gen/sources_1/ip/ila_1_4/hdl/verilog" +incdir+"E:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../xdma_u280_official_ex.gen/sources_1/ip/ila_1_4/hdl/verilog" +incdir+"E:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../xdma_u280_official_ex.gen/sources_1/ip/ila_1_4/hdl/verilog" +incdir+"E:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
