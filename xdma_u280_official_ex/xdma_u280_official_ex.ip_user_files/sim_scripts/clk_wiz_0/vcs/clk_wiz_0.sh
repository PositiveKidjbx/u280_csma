...
#
# Script generated by Vivado on Fri Oct 11 22:56:05 +0800 2024
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"$ref_dir/../../../ipstatic" +incdir+"../../../ipstatic" +incdir+"E:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../ipstatic" +incdir+"../../../ipstatic" +incdir+"E:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" +incdir+"../../../ipstatic" +incdir+"E:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
