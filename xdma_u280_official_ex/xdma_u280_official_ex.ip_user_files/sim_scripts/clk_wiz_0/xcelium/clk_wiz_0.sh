...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"$ref_dir/../../../ipstatic" +incdir+"../../../ipstatic" +incdir+"E:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"$ref_dir/../../../ipstatic" +incdir+"../../../ipstatic" +incdir+"E:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"$ref_dir/../../../ipstatic" +incdir+"../../../ipstatic" +incdir+"E:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
