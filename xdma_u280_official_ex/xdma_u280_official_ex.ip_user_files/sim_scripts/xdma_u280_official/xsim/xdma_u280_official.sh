...
# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L xdma_v4_1_23 -L xilinx_vip"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L gtwizard_ultrascale_v1_7_16 -L xil_defaultlib -L blk_mem_gen_v8_4_6 -L xdma_v4_1_23 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot xdma_u280_official xil_defaultlib.xdma_u280_official xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim xdma_u280_official -key {Behavioral:sim_1:Functional:xdma_u280_official} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb xdma_u280_official.wdb xsim.dir libdpi.so)
