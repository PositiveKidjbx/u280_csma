...
#
# Script generated by Vivado on Fri Oct 11 22:55:59 +0800 2024
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : xdma_u280_official.sh
...
#
# Usage        : xdma_u280_official.sh
#                xdma_u280_official.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                xdma_u280_official.sh [-reset_run]
#                xdma_u280_official.sh [-reset_log]
#                xdma_u280_official.sh [-help]
#
...
#                script (type 'xdma_u280_official.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname gtwizard_ultrascale_v1_7_16 -libname xil_defaultlib -libname blk_mem_gen_v8_4_6 -libname xdma_v4_1_23 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm gtwizard_ultrascale_v1_7_16 xil_defaultlib blk_mem_gen_v8_4_6 xdma_v4_1_23)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "xdma_u280_official.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./xdma_u280_official.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"$ref_dir/../../../../xdma_u280_official_ex.gen/sources_1/ip/xdma_u280_official/ip_0/source" +incdir+"$ref_dir/../../../ipstatic/ipshared/03b2/hdl/verilog" +incdir+"../../../../xdma_u280_official_ex.gen/sources_1/ip/xdma_u280_official/ip_0/source" +incdir+"../../../ipstatic/ipshared/03b2/hdl/verilog" +incdir+"E:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.xdma_u280_official xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.xdma_u280_official -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log xdma_u280_official_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./xdma_u280_official.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: xdma_u280_official.sh [-help]\n\
Usage: xdma_u280_official.sh [-step]\n\
Usage: xdma_u280_official.sh [-lib_map_path]\n\
Usage: xdma_u280_official.sh [-reset_run]\n\
Usage: xdma_u280_official.sh [-reset_log]\n\
Usage: xdma_u280_official.sh [-keep_index]\n\
Usage: xdma_u280_official.sh [-noclean_files]\n\n\
