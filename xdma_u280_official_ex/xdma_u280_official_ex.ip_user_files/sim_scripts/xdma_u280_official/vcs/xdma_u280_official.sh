...
design_libs=(xilinx_vip xpm gtwizard_ultrascale_v1_7_16 xil_defaultlib blk_mem_gen_v8_4_6 xdma_v4_1_23)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.xdma_u280_official xil_defaultlib.glbl -o xdma_u280_official_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./xdma_u280_official_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key xdma_u280_official_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc xdma_u280_official_simv.daidir vcs_lib c.obj)
