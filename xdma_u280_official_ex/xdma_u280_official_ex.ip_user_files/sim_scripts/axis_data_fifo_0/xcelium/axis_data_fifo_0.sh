...
#
# Script generated by Vivado on Thu Oct 24 20:45:00 +0800 2024
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname axis_infrastructure_v1_1_0 -libname axis_data_fifo_v2_0_10 -libname xil_defaultlib -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm axis_infrastructure_v1_1_0 axis_data_fifo_v2_0_10 xil_defaultlib)
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"$ref_dir/../../../ipstatic/hdl" +incdir+"../../../ipstatic/hdl" +incdir+"E:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"$ref_dir/../../../ipstatic/hdl" +incdir+"../../../ipstatic/hdl" +incdir+"E:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  xmvlog -work axis_infrastructure_v1_1_0 $xmvlog_opts +incdir+"$ref_dir/../../../ipstatic/hdl" +incdir+"../../../ipstatic/hdl" +incdir+"E:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axis_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axis_data_fifo_v2_0_10 $xmvlog_opts +incdir+"$ref_dir/../../../ipstatic/hdl" +incdir+"../../../ipstatic/hdl" +incdir+"E:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axis_data_fifo_v2_0_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"$ref_dir/../../../ipstatic/hdl" +incdir+"../../../ipstatic/hdl" +incdir+"E:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
