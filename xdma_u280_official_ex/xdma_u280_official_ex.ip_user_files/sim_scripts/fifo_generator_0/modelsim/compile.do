...
vlog -work xpm  -incr -mfcu  -sv -L xdma_v4_1_23 -L xilinx_vip "+incdir+E:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
...
vlog -work fifo_generator_v13_2_8  -incr -mfcu  "+incdir+E:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
...
vlog -work xil_defaultlib  -incr -mfcu  "+incdir+E:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
