...
#
# Script generated by Vivado on Fri Oct 25 14:39:45 +0800 2024
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"E:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"E:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  vlogan -work fifo_generator_v13_2_8 $vlogan_opts +v2k +incdir+"E:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"E:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
