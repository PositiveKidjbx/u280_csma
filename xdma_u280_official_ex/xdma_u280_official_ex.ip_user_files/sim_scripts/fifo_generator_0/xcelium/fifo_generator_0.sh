...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"E:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"E:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  xmvlog -work fifo_generator_v13_2_8 $xmvlog_opts +incdir+"E:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"E:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
