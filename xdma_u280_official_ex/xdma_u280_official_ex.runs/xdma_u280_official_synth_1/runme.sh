...
HD_PWD='e:/vivado_ex/xdma_u280_official_ex/xdma_u280_official_ex.runs/xdma_u280_official_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xdma_u280_official.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xdma_u280_official.tcl
